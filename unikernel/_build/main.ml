(* Generated by mirage configure -t unix --net=socket --http=8080 --https=4433 (2019-05-07 04:20:58-00:00). *)
...
module Dispatch1 = Dispatch.HTTPS(Pclock)(Static1)(Static2)
...
let key1 = lazy (
  ...
  return (Functoria_runtime.with_argv (List.map fst Key_gen.runtime_keys) "https" _argv_unix1)
  )
...
let f11 = lazy (
  ...
  __http1 >>= fun _http1 ->
  Dispatch1.start _pclock1 _static11 _static21 _http1
  )
